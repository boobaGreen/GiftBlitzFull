...
import {
    ...
    ArrowRight, AlertCircle, Zap, TrendingUp
} from 'lucide-react';
    ...
    return (
        <div className="pb-20">
            ...
            <section className="relative min-h-[85vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed">
                        The first trustless marketplace secured by Game Theory and IOTA Smart Contracts.
                        No middleman. No scams. Just code.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <Link to="/market" className="group relative px-8 py-4 bg-white text-black text-lg font-bold rounded-xl overflow-hidden hover:scale-105 transition-transform">
                            <span className="relative z-10 flex items-center gap-2">
                                Explore Market <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </span>
                        </Link>
                        <Link to="/create" className="px-8 py-4 bg-white/5 text-white text-lg font-bold rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
                            Sell Gift Card
                        </Link>
                    </div>
                </motion.div>
            ...
            <section className="py-24 bg-black relative border-y border-white/5 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Why Gift Cards Suck (Today).</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                            The current market is fundamentally flawed. It's either unsafe, expensive, or wasteful.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            <div className="h-full bg-black/40 rounded-[20px] p-8 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-xl font-bold text-red-100 mb-2">The Trust Dilemma</h3>
                                <p className="text-red-200/60 text-sm leading-relaxed mb-6">
                                    "Who sends first?" <br />
                                    If I send the code, you might vanish. If I pay first, you might send a used code.
                                </p>
                                <div className="mt-auto w-full p-3 rounded-xl bg-red-500/10 border border-red-500/20">
                                    <div className="text-xs font-bold text-red-400 uppercase">Risk Level</div>
                        ...
                        >
                            ...
                            <div className="h-full bg-black/40 rounded-[20px] p-8 flex flex-col items-center text-center relative z-10">
                                ...
                                <h3 className="text-xl font-bold text-red-100 mb-2">Trapped Value</h3>
                                <p className="text-red-200/60 text-sm leading-relaxed mb-6">
                                    Unused cards collect dust in drawers because liquidating them is too hard.
                                </p>
                                <div className="mt-auto w-full p-3 rounded-xl bg-red-500/10 border border-red-500/20">
                                    <div className="text-xs font-bold text-red-400 uppercase">Global Annual Loss</div>
                                    <div className="text-2xl font-black text-white">$23 Billion</div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="h-full bg-black/40 rounded-[20px] p-8 flex flex-col items-center text-center">
                                ...
                                <div className="absolute top-10 right-10 rotate-12">
                                    <div className="px-2 py-1 bg-red-600 text-white text-[10px] font-bold rounded rotate-12 shadow-lg">SCAM?</div>
                                </div>
                                <h3 className="text-xl font-bold text-red-100 mb-2">The Middleman Tax</h3>
                                <p className="text-red-200/60 text-sm leading-relaxed mb-6">
                                    Safe sites charge 30%+ fees. P2P sites are wild west minefields of scammers.
                                </p>
                                <div className="mt-auto w-full p-3 rounded-xl bg-red-500/10 border border-red-500/20">
                                    <div className="text-xs font-bold text-red-400 uppercase">Avg. Platform Fee</div>
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6">The Web3 Solution</h2>
                        <p className="text-xl text-gray-400">Powered by IOTA. Secured by Math.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold text-white mb-3">Tokenization</h3>
                            <p className="text-gray-400 leading-relaxed mb-4">
                                Your reputation is a <b>Soulbound NFT</b>. It can't be bought, sold, or faked. It proves you are trustworthy on-chain.
                            </p>
                            <span className="text-xs font-bold text-cyan-500 uppercase tracking-wider">Reputation NFT</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold text-white mb-3">Notarization</h3>
                            <p className="text-gray-400 leading-relaxed mb-4">
                                Every trade step is an immutable event. The blockchain is the ultimate judge, creating a perfect audit trail.
                            </p>
                            <span className="text-xs font-bold text-purple-500 uppercase tracking-wider">Immutable History</span>
                        </motion.div>
            ...
            <section className="py-24 relative bg-slate-900/50 border-y border-white/5 overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Earn Trust. Level Up.</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                            Your <b>Soulbound Reputation NFT</b> is your passport. It records your trading history on-chain.
                            Real reliability unlocks real value.
                        </p>
                    </div>
                            ...
                            <div className="relative h-full bg-[#0f172a] p-1 rounded-3xl border border-white/10 group-hover:border-blue-500/30 transition-colors shadow-2xl">
                                <div className="h-full bg-slate-900/50 rounded-[20px] p-6 flex flex-col overflow-hidden">
                                    ...
                                    <div className="mt-auto">
                                        <div className="text-[10px] text-blue-300/70 uppercase tracking-widest mb-1">Current Limit</div>
                        ...
                        >
                            ...
                            <div className="relative h-full bg-[#0f172a] p-1 rounded-3xl border border-cyan-500/30 shadow-[0_0_30px_rgba(6,182,212,0.1)] group-hover:shadow-[0_0_50px_rgba(6,182,212,0.2)] transition-shadow">
                                <div className="h-full bg-slate-900/50 rounded-[20px] p-6 flex flex-col overflow-hidden">
                                    ...
                                    {/* Benefit */}
                                    <div className="mt-auto">
                                        <div className="text-[10px] text-cyan-300/70 uppercase tracking-widest mb-1">Current Limit</div>
                                        <div className="flex items-baseline gap-2">
                        ...
                        >
                            ...
                            <div className="relative h-full bg-[#0f172a] p-1 rounded-3xl border border-purple-500/50 shadow-[0_0_40px_rgba(168,85,247,0.15)] group-hover:shadow-[0_0_60px_rgba(168,85,247,0.3)] transition-shadow">
                                ...
                                <div className="h-full bg-slate-900/50 rounded-[20px] p-6 flex flex-col overflow-hidden relative">
                                    ...
                                    {/* Header */}
                                    <div className="flex items-center justify-between mb-6">
                                        <h3 className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Veteran</h3>
                                    ...
                                    {/* Benefit */}
                                    <div className="mt-auto">
                                        <div className="text-[10px] text-purple-300/70 uppercase tracking-widest mb-1">Current Limit</div>
                                        <div className="flex items-baseline gap-2">
            ...
            <section className="py-24 bg-gradient-to-b from-transparent to-black/50">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 text-lg">Trustless trading in 3 simple steps.</p>
                    </div>
                    ...
                    <div className="relative pt-8 pb-12">
                        ...
                        <div className="grid md:grid-cols-3 gap-12 text-center">
                            {[
                                { step: "1", title: "List & Lock", desc: "Seller sets price & locks the card code in the smart contract.", icon: Lock },
                                { step: "2", title: "Dual Deposit", desc: "Buyer matches the deposit. Funds are held in neutral escrow.", icon: Shield },
                                { step: "3", title: "Swap & Release", desc: "Buyer verifies code. Funds release instantly. Reputation grows.", icon: Zap }
                            ].map((item, i) => (
                                <motion.div
                                    key={i}
                                    initial={{ opacity: 0, y: 30 }}
            ...
            <section className="py-20 text-center">
                <h2 className="text-3xl font-bold text-white mb-8">Ready to reclaim your value?</h2>
                <Link to="/market" className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold rounded-xl hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] transition-all">
